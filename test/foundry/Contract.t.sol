...
uint256 constant PERCENTX100 = 5;
...
contract ContractTest is Test {
  function acceptableInterval(
    uint256 amount,
    uint256 target
  ) public pure returns (bool) {
    return ((target < PERCENTX100 || amount >= target - PERCENTX100) &&
      amount <= target + PERCENTX100);
  }
  ...
  ERC20DecimalsMock public agEur =
    new ERC20DecimalsMock("Angle Euro", "agEur", 18);
  ...
  TransparentUpgradeableProxy public vaultRaw =
